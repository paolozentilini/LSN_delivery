...
void Equilibration(){
  ...
  for(int istep=1; istep<=11*n_equilibration; ++istep){
    Move();
    if(istep%10) Measure_Equilibration();
  }
...
void Measure_Equilibration(){ //Properties measurement
  ...
  Epot.open("../../Esercizio4/Risultati/solid_equilibration_epot.dat",ios::app);
  Ekin.open("../../Esercizio4/Risultati/solid_equilibration_ekin.dat",ios::app);
  Temp.open("../../Esercizio4/Risultati/solid_equilibration_temp.dat",ios::app);
  Etot.open("../../Esercizio4/Risultati/solid_equilibration_etot.dat",ios::app);
...
void Averages(int iblk){
  ...
  Epot.open("../../Esercizio4/Risultati/solid_epot.dat",ios::app);
  Ekin.open("../../Esercizio4/Risultati/solid_ekin.dat",ios::app);
  Temp.open("../../Esercizio4/Risultati/solid_temp.dat",ios::app);
  Etot.open("../../Esercizio4/Risultati/solid_etot.dat",ios::app);
