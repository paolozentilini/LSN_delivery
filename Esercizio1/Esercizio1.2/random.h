...
class Random {
	...
	public:
  	...
  	double get_gaussian(double mean, double sigma);	//Restituisce un numero gaussiano con varianza sigma e media mean
		double get_esponential(double lambda); //Restituisce un numero estratto dalla distribuzione esponenziale
		double get_cauchy_lorentz(double mu, double gamma); //Restituisce un numero estratto dalla distribuzione di Cauchy-Lorentz
